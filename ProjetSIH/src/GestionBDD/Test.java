...
public class Test {
 ...
 /*
       ...
       LettreDeSortie lettre = new LettreDeSortie();
        lettre = new LettreDeSortie("180000006", "180100002","PH0001","j autorise ma patiente a sortir...");
        DAO<LettreDeSortie> LettreDeSortieDAO = new LettreDeSortieDAO(BDDconnection.getInstance());
        LettreDeSortieDAO.create(lettre);
 ...
 /*
     ...
     /*   PersonnelHospitalier pat = new PersonnelHospitalier();
        ...
        System.out.println(PersonnelHospitalierDAO.create(pat));
        
        PersonnelHospitalierDAO.connex("PH0008","tchatcha51");
        System.out.println( PersonnelHospitalierDAO.connex("PH0008","tchatcha51").getNomph());
        PersonnelHospitalierDAO.find("Mac", "Arena");
        System.out.println(PersonnelHospitalierDAO.find("Mac", "Arena").get(0).getId());
        PersonnelHospitalierDAO.findIpp("PH0008");
System.out.println(PersonnelHospitalierDAO.findIpp("PH0008").get(0).getNomph());*/
...
*/
     ...
     /*   ObservationsDAO dmadao = new ObservationsDAO(BDDconnection.getInstance());
        ...
        System.out.println("is empty");
             ...
             ArrayList<Operations> dm2 = dmadao.findIpp("180000003");
        if (!dm2.isEmpty()){
            System.out.println(dm2.get(0).getIpp() + "   " + dm2.get(0).getOperation());
        } else{
        System.out.println("is empty");
        }
        */
    ...
    /*    PrescriptionsDAO dmadao = new PrescriptionsDAO(BDDconnection.getInstance());
        ...
        if (!dm.isEmpty()){
            System.out.println(dm.get(0).getIpp() + " Prescriptin  " + dm.get(0).getPrescription());
        } else{
        System.out.println("is empty");
        }
             
        ArrayList<Prescriptions> dm2 = dmadao.findIpp("180000005");
        if (!dm2.isEmpty()){
            for (Prescriptions i: dm2){
            System.out.println(i.getIpp() + "  Prescriptin:  " + i.getPrescription());
            }  } else{
        System.out.println("is empty");
        }*/
 ...
 /*
        ...
        ArrayList<Resultats> dm2 = dmadao.findIpp("180000003");
        if (!dm2.isEmpty()){
            System.out.println(dm2.get(0).getIpp() + "   " + dm2.get(0).getResultat());
        } else{
        System.out.println("is empty");
        }*/
 ...
 /*
     ...
     /*   DossierMedicalDAO dm1dao = new DossierMedicalDAO(BDDconnection.getInstance());
        dmdao.updateIpp("123456789", "180000001");
        ArrayList<DossierMedical> dm = dm1dao.findSer("123456789", "180100001", "Cardiologie");
        System.out.println(dm.get(0).getIpp() + "   " + dm.get(0).getService());
        dmdao.updateIpp("180000001", "123456789");
             */
 /*DossierMedicalDAO dm1dao = new DossierMedicalDAO(BDDconnection.getInstance());
       dm1dao. updateCorrespondance( "180000001","180100001","Anesthesie");
        ArrayList<DossierMedical> dm = dm1dao.findSer("123456789", "180100001", "Cardiologie");
        System.out.println(dm.get(0).getIpp() + "   " + dm.get(0).getService());
        dmdao.updateCorrespondance("180000001","180100001","Ragiologie");
        */
      /*  DossierMedicoAdministratifDAO dmadao = new DossierMedicoAdministratifDAO(BDDconnection.getInstance());
        dmadao.updateIpp("123456789", "180000001");
        ArrayList<DossierMedicoAdministratif> dma = dmadao.findSer("123456789", "180100001", "Cardiologie");
        System.out.println(dma.get(0).getIpp() + "   " + dma.get(0).getService());
        dmadao.updateIpp("180000001", "123456789");
 ...
 */
 ...
 OperationsDAO predao = new OperationsDAO(BDDconnection.getInstance());
        predao.updateIpp("123456789", "180000001");
        ArrayList<Operations> press = predao.findIpp("123456789");
        System.out.println(press.get(0).getIpp() + "   " + press.get(0).getOperation());
        predao.updateIpp("180000001", "123456789");*/
